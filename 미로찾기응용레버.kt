...
//    }
//
//    private fun mazeRunner(start: Node, end: Node, maze: Array<CharArray>, visited: Array<BooleanArray>): Int {
...
//    }
//
//    private fun findStartLeverExit(maps: Array<String>): Map<String, Node> {
//        val info = mutableMapOf<String, Node>()
//        for (y in maps.indices) {
//            for (x in maps[0].indices) {
//                if (maps[y][x] == 'S') info["Start"] = Node(y = y, x = x)
//                if (maps[y][x] == 'L') info["Lever"] = Node(y = y, x = x)
//                if (maps[y][x] == 'E') info["Exit"] = Node(y = y, x = x)
//            }
//        }
//        return info
//    }
